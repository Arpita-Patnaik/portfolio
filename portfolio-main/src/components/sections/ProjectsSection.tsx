...
const projects = [
  {
    ...
    description: "Developed a machine learning pipeline achieving 82.3% ROC AUC to predict employee mental health treatment needs and drive data-backed workplace wellness strategies.",
    tech: ["Python", "Scikit-learn", "Pandas", "XGBoost", "Random Forest"],
    features: [
      "Predictive classification pipeline",
      "82.3% ROC AUC performance",
      "Automated hyperparameter tuning",
      "Multi-model benchmarking",
      "TF-IDF & ColumnTransformer preprocessing",
      "Feature importance analysis",
      "Workplace interference correlation",
      "Actionable HR wellness insights"
    ],
    icon: Brain,
    color: "text-accent",
    bgColor: "bg-accent/20",
    // link: "#",
    github: "https://github.com/Arpita-Patnaik/Mental-Health-Analyzer",
  },
  {
    ...
    // link: "#",
    github: "https://github.com/Arpita-Patnaik/LC50-PROJECT",
  },
  {
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex space-x-2">
                    {(() => {
                      const gh = (project as any).github ? (project as any).github.replace(/^#+/, "") : undefined;
                      return gh && gh.startsWith("http") ? (
                    ...
                    {(() => {
                      const ln = (project as any).link ? (project as any).link.replace(/^#+/, "") : undefined;
                      return ln && ln.startsWith("http") ? (
